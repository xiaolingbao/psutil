...
.. function:: sysinfo()
  ...
  depending on the platform.
     ...
     +===============+=========+=========+=======+============+=============+==============+
     | procs_running |         |         |       | max_files  | max_files   | max_files    |
     +---------------+---------+---------+-------+------------+-------------+--------------+
     | procs_blocked |         |         |       | max_procs  | max_procs   | max_procs    |
     +---------------+---------+---------+-------+------------+-------------+--------------+
     | ctx_switches  |         |         |       | max_pid    | max_threads | ctx_switches |
     +---------------+---------+---------+-------+------------+-------------+--------------+
     | open_files    |         |         |       | open_files | open_files  | interrupts   |
     +---------------+---------+---------+-------+------------+-------------+--------------+
